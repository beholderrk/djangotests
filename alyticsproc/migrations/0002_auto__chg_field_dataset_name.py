...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'alyticsproc_dataset', 'name', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'DataSet.name'
        db.alter_column(u'alyticsproc_dataset', 'name', self.gf('django.db.models.fields.TextField')(max_length=25))
